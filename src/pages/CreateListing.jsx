...
export default function CreateListing() {
  return (
    <main className="p-3 max-w-4xl mx-auto">
        ...
        <from className="flex flex-col sm:flex-row gap-4" >
...
<div className="flex flex-wrap gap-6">
    ...
    <div className="flex items-center gap-2">
        ...
        <span className="text-xs">( $ / month)</span>
            ...
            <button className="p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80">Creating Listing</button>
            </div>
